...
public class CloudComputer extends AbstractPersistable implements Labeled {
    ...
    public CloudComputer(long id, int cpuPower, int memory, int networkBandwidth, int cost, int Flexible_time) {
        super(id);
    ...
    public void setFlexible_time(int Flexible_time) {
        this.Flexible_time = Flexible_time;
    }
    ...
    public int getMultiplicand() {
        return cpuPower * memory * networkBandwidth * Flexible_time;
    }
