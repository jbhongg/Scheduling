...
public class CloudProcess extends AbstractPersistable {
    ...
    public CloudProcess(long id, int requiredCpuPower, int requiredMemory, int requiredNetworkBandwidth, int Processing_time) {
        super(id);
    ...
    public int getRequiredMultiplicand() {
        return requiredCpuPower * requiredMemory * requiredNetworkBandwidth * Processing_time;
    }
