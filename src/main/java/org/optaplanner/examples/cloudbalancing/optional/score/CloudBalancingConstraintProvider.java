...
public class CloudBalancingConstraintProvider implements ConstraintProvider {
    ...
    public Constraint[] defineConstraints(ConstraintFactory constraintFactory) {
        return new Constraint[]{
                ...
                Processing_time(constraintFactory)
        };
    }
    ...
    private Constraint Processing_time(ConstraintFactory constraintFactory) {
        return constraintFactory.from(CloudProcess.class)
                .groupBy(CloudProcess::getComputer, sum(CloudProcess::getProcessing_time))
                .filter((computer, Processing_time) -> Processing_time > computer.getFlexible_time())
                .penalize("Processing_timeTotal",
                        HardSoftScore.ONE_HARD,
                        (computer, Processing_time) -> Processing_time - computer.getFlexible_time());
    }
