...
public class TaskType extends AbstractPersistable implements Labeled {
    ...
    private List<Type> requiredTypeList;

    public TaskType() {
    }

    public TaskType(long id, String code, int baseDuration, int volume) {
        super(id);
        this.code = code;
        this.baseDuration = baseDuration;
        this.volume = volume;
        requiredTypeList = new ArrayList<>();
    }
    ...
    public List<Type> getRequiredTypeList() {
        return requiredTypeList;
    }

    public void setRequiredTypeList(List<Type> requiredTypeList) {
